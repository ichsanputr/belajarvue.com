...
<template>
    <div class="bg-[#FBEEE4] py-10 md:py-14 border-t border-slate-300">
        <div class="mx-auto max-[900px]:w-[90%] md:w-[30%]">
            ...
            <button
                class="bg-[#4349ff] py-2 text-white font-medium rounded-md text-sm mt-4 mb-4 w-[100px]">Login</button>
            <div class="mb-4">
                <span class="font-medium text-sm md:text-md">Atau login dengan:</span>
            </div>
            <div class="flex">
            ...
            <div class="mt-4">
                <span class="text-sm">Belum mempunyai akun? <span class="underline text-[#4349ff] cursor-pointer">Daftar</span></span>
            </div>
        </div>
    </div>
</template>
