...
<template>
    <div class="bg-[#FBEEE4] pb-10">
        ...
        <!-- Article body -->
        <div class="mx-auto w-full md:w-[85%] py-8 pt-[4rem] block md:flex max-w-screen-xl">
            <div class="w-[90%] md:w-[65%] md:mx-0 mx-auto">
                <p>Dalam artikel ini kita akan belajar bagaimana cara men-deploy Next.js App menggunakan Laravel Forge. Tentu ini sangat mudah dilakukan karena pada dasarnya, kita sendiri bisa membuat template nginx sendiri di dalam dashboard nya.</p>
                <h2 class="font-semibold">Setup Nginx Template</h2>
                <p v-for="i in 7">Dalam artikel ini kita akan belajar bagaimana cara men-deploy Next.js App menggunakan Laravel Forge. Tentu ini sangat mudah dilakukan karena pada dasarnya, kita sendiri bisa membuat template nginx sendiri di dalam dashboard nya.</p>
            </div>
